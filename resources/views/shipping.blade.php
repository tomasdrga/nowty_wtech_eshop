...
<head>
  ...
  <title>Nowty Clothing • Shipping</title>
  <meta name="description" content="Shipping information page of Nowty Clothing website."/>
...
<body>
  ...
  <main class="grid grid-rows-10 grid-cols-6 gap-y-4 grid-flow-col-dense max-w-screen h-screen lg:overflow-hidden">
    ...
    <section class="row-span-10 col-span-6 flex flex-col h-screen">
      ...
      <section class="flex-1 w-full grid grid-cols-5 items-center max-lg:items-start">
        <div class="flex flex-row col-span-5 lg:col-span-5 items-center justify-center mx-4 md:mx-8">
          <div class="flex flex-col w-screen gap-y-3">
            <section class="flex justify-center justify-around my-2 md:my-4 lg:mb-6">
              <h1 class="text-base sm:text-xl md:text-2xl lg:text-3xl font-bold">Shipping</h1>
            </section>
            <section class="flex flex-col overflow-auto items-center">
              <div>
                <div class="border-[#260065] border-b-[1px] sm:border-b-2 mb-1">
                  <h2 class="text-xs sm:text-lg md:text-xl lg:text-2xl font-bold">When will my drip be shipped?</h2>
                </div>
                <p class="text-xs sm:text-base md:text-lg lg:text-xl opacity-75 pb-1">Slovak Republic €12 (3-5 working days delivery)</p>
                <p class="text-xs sm:text-base md:text-lg lg:text-xl opacity-75 pb-1">Czech Republic €12 (3-5 working days delivery)</p>
                <p class="text-xs sm:text-base md:text-lg lg:text-xl opacity-75 pb-1">Romania €12 (5-7 working days delivery)</p>
                <p class="text-xs sm:text-base md:text-lg lg:text-xl opacity-75 pb-1">Norway €24 (5-7 working days delivery)</p>
                <p class="text-xs sm:text-base md:text-lg lg:text-xl opacity-75 pb-1">Denmark €12 (3-5 working days delivery)</p>
              </div>
            </section>
          </div>
        </div>
