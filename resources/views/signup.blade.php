            ...
            <form class="flex flex-col gap-4" action="#">
              ...
              <section class="flex items-start">
                <div class="flex items-center h-8">
                  <input type="checkbox" id="checkbox-terms" class="w-5 h-5 rounded-lg accent-[#260065] cursor-pointer" />
                </div>
                <div class="text-sm ml-3">
                  <label for="checkbox-terms" class="leading-3 text-[.6rem] sm:text-[.7rem] opacity-75">By creating an account, I agree to our Terms of use and Privacy Policy <a class="font-medium hover:underline hover:text-[#531DACFF]" href="terms_conditions.html">Terms and Conditions</a></label>
                </div>
              </section>
              ...
              <footer>
                ...
                <div class="sign-up">
                  <p class="block text-center leading-3 text-[.6rem] sm:text-[.7rem] mx-auto py-2 opacity-80">Already have an account? <a class="font-bold underline underline-offset-2 hover:text-[#531DACFF]" href="login.html">Login</a></p>
                </div>
              </footer>
              <!--Action buttons end-->
              <!--Card footer end-->
