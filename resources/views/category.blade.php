...
<body>
      ...
      <header class="self-start flex-none w-full">
        <div class="flex justify-between">
          ...
          <div class="lg:hidden w-1/4 md:w-1/3">
            <a class="justify-start w-24 sm:w-32 md:w-36 h-auto pt-2" href="index.html">
      ...
      <section class="flex-1 flex-col justify-between w-full">
        ...
        <section class="flex flex-row justify-between px-4 border-b-2 border-[#260065] pt-2">
          ...
          <div class="flex flex-row gap-x-8 overflow-x-auto no-scrollbar text-xs md:text-sm lg:text-base">
            <button class="tab-btn tab-inactive text-nowrap font-semibold" data-target="tab1">NEW</button>
            <button class="tab-btn tab-active text-nowrap font-semibold" data-target="tab2">ALL</button>
            <button class="tab-btn tab-inactive text-nowrap font-semibold" data-target="tab3">BOTTOMS</button>
            <button class="tab-btn tab-inactive text-nowrap font-semibold" data-target="tab4">HOODS</button>
            <button class="tab-btn tab-inactive text-nowrap font-semibold" data-target="tab5">TEES</button>
            <button class="tab-btn tab-inactive text-nowrap font-semibold" data-target="tab6">HATS</button>
            <button class="tab-btn tab-inactive text-nowrap font-semibold" data-target="tab7">ACCESSORIES</button>
          </div>
          <!--Tab system end-->
        ...
        <section class="overflow-auto max-h-[calc(100vh-12.5rem)] sm:max-h-[calc(100vh-12rem)] md:max-h-[calc(100vh-13rem)] lg:md:max-h-[calc(100vh-6rem)]">
          <!--New tab-->
          <div id="tab1" class="tab-content hidden grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 items-start justify-items-center gap-8 px-4 sm:px-16 py-8">
          ...
          <!--New tab end-->
          <!--All tab-->
          <div id="tab2" class="tab-content grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 items-start justify-items-center gap-8 px-4 sm:px-16 py-8">
            <a class="flex flex-col gap-y-4 min-w-42 min-h-72 max-w-52 max-h-96 p-2 rounded-lg hover:outline hover:outline-2 hover:outline-[#260065]/20 hover:text-[#531DACFF] hover:transition-all hover:transition-100" href="product_detail.html">
              <div class="rounded-lg bg-[#F5F5F5] px-4 py-2 md:px-8 md:py-4">
                <img class="min-w-16 max-h-56 object-contain" src="../img/products/palace_5.png" alt="">
              </div>
          ...
          <!--All tab end-->
          <!--Bottoms tab-->
          <div id="tab3" class="tab-content hidden grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 items-start justify-items-center gap-8 px-4 sm:px-16 py-8">
            <a class="flex flex-col gap-y-4 min-w-42 min-h-72 max-w-52 max-h-96 p-2 rounded-lg hover:outline hover:outline-2 hover:outline-[#260065]/20 hover:text-[#531DACFF] hover:transition-all hover:transition-100" href="product_detail.html">
              <div class="rounded-lg bg-[#F5F5F5] px-4 py-2 md:px-8 md:py-4">
                <img class="min-w-16 max-h-56 object-contain" src="../img/products/palace_5.png" alt="">
              </div>
          ...
          <!--Bottoms tab end-->
          <!--Hoods tab-->
          <div id="tab4" class="tab-content hidden grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 items-start justify-items-center gap-8 px-4 sm:px-16 py-8">
            <a class="flex flex-col gap-y-4 min-w-42 min-h-72 max-w-52 max-h-96 p-2 rounded-lg hover:outline hover:outline-2 hover:outline-[#260065]/20 hover:text-[#531DACFF] hover:transition-all hover:transition-100" href="product_detail.html">
              <div class="rounded-lg bg-[#F5F5F5] px-4 py-2 md:px-8 md:py-4">
                <img class="min-w-16 max-h-56 object-contain" src="../img/products/palace_5.png" alt="">
              </div>
          ...
          <!--Hoods tab end-->
          <!--Tees tab-->
          <div id="tab5" class="tab-content hidden grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 items-start justify-items-center gap-8 px-4 sm:px-16 py-8">
            <a class="flex flex-col gap-y-4 min-w-42 min-h-72 max-w-52 max-h-96 p-2 rounded-lg hover:outline hover:outline-2 hover:outline-[#260065]/20 hover:text-[#531DACFF] hover:transition-all hover:transition-100" href="product_detail.html">
              <div class="rounded-lg bg-[#F5F5F5] px-4 py-2 md:px-8 md:py-4">
                <img class="min-w-16 max-h-56 object-contain" src="../img/products/palace_5.png" alt="">
              </div>
          ...
          <!--Tees tab end-->
          <!--Hats tab-->
          <div id="tab6" class="tab-content hidden grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 items-start justify-items-center gap-8 px-4 sm:px-16 py-8">
            <a class="flex flex-col gap-y-4 min-w-42 min-h-72 max-w-52 max-h-96 p-2 rounded-lg hover:outline hover:outline-2 hover:outline-[#260065]/20 hover:text-[#531DACFF] hover:transition-all hover:transition-100" href="product_detail.html">
              <div class="rounded-lg bg-[#F5F5F5] px-4 py-2 md:px-8 md:py-4">
                <img class="min-w-16 max-h-56 object-contain" src="../img/products/palace_5.png" alt="">
              </div>
          ...
          <!--Hats tab end-->
          <!--Accessories tab-->
          <div id="tab7" class="tab-content hidden grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 items-start justify-items-center gap-8 px-4 sm:px-16 py-8">
            <a class="flex flex-col gap-y-4 min-w-42 min-h-72 max-w-52 max-h-96 p-2 rounded-lg hover:outline hover:outline-2 hover:outline-[#260065]/20 hover:text-[#531DACFF] hover:transition-all hover:transition-100" href="product_detail.html">
              <div class="rounded-lg bg-[#F5F5F5] px-4 py-2 md:px-8 md:py-4">
                <img class="min-w-16 max-h-56 object-contain" src="../img/products/palace_5.png" alt="">
              </div>
  ...
  <div id="navbar-overlay" class="fixed -bottom-full left-0 z-[1] flex flex-col justify-between w-screen h-screen bg-white transition-all duration-250 md:overflow-hidden">
    ...
    <nav class="self-center flex flex-col items-center overlay-content">
      <a class="leading-relaxed md:leading-10 font-bold text-xl md:text-2xl hover:text-[#531DACFF] focus:text-[#531DACFF]" href="product_detail.html">Products</a>
